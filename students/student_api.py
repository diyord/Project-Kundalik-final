...
from database.student_servise import register_student_db, get_student_db, get_all_students_db, delete_student_db, \
    edit_student_db, check_student_db
...
async def register_student(data: StudentRegistrationValidator):
    ...
    if checker:
        return {'message': 'Student allready registed'}
    else:
        result = register_student_db(**new_student_data)
...
async def get_all_students():
    ...
    if all_students:
        ...
        return {'message': 'There no student'}
